...
serve(async (req: Request) => {
  ...
  const stripe = new Stripe(stripeSecret, { apiVersion: "2023-10-16" });
    ...
    const prices = {
      basic: { amount: 4000, name: "Basic Plan" }, // ₹40
      premium: { amount: 5000, name: "Premium Plan" }, // ₹50
      enterprise: { amount: 10000, name: "Enterprise Plan" } // ₹100
    };

    const selectedPlan = prices[planId as keyof typeof prices];
