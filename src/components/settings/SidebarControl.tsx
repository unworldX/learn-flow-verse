...
export default function SidebarControl({ 
  ...
  const [selectedMode, setSelectedMode] = useState<SidebarMode>(() => {
    // Use initialMode if provided, otherwise load from localStorage
    if (initialMode) return initialMode;
    const stored = localStorage.getItem(SIDEBAR_MODE_STORAGE_KEY) as SidebarMode | null;
  ...
  useEffect(() => {
    ...
    localStorage.setItem(SIDEBAR_MODE_STORAGE_KEY, selectedMode);
